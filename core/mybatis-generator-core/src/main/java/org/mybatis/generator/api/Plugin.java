...
public interface Plugin {
     ...
     * called in the MyBatis3DynamicSql runtime. This method is only called if the table has generated keys.
     *
     * @param method
    ...
    /**
     * This method is called when the insert function has been generated for the mapper interface. This method is only
     * called in the MyBatis3Kotlin runtime. This method is only called if the table has generated keys.
     *
     * @param kotlinFunction
     ...
     *            The class containing information about the table as introspected from the database
     *
     * @return true if the function should be generated, false if the generated function should be ignored. In the case
    ...
    /**
     * This method is called when the insert multiple method has been generated for the mapper interface. This method is
     * only called in the MyBatis3DynamicSql runtime. This method is only called if the table has generated keys.
     *
     * @param method
     *            the generated insert method
     * @param interfaze
     ...
     *            The class containing information about the table as introspected from the database
     *
     * @return true if the method should be generated, false if the generated function should be ignored. In the case of
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    ...
    /**
     * Called when the general count method has been generated. This is the replacement for countByExample in the
    ...
    /**
     * Called when the general delete method has been generated. This is the replacement for deleteByExample in the
     * MyBatis Dynamic SQL V2 runtime.
     *
     * @param method
    ...
    /**
     * Called when the general select method has been generated. This is the replacement for selectByExample in the
     * MyBatis Dynamic SQL V2 runtime.
     *
     * @param method
    ...
    /**
     * Called when the general update method has been generated. This is the replacement for updateByExample in the
     * MyBatis Dynamic SQL V2 runtime.
     *
     * @param method
    ...
    /**
     * This method is called when the insert multiple method has been generated in the client interface. This method is
     * only called in the MyBatis3DynamicSql runtime.
     *
     * @param method
     ...
     *
     * @param field
     *            the generated selectList field
     * @param interfaze
     *            the partially generated mapper interfaces
     * @param introspectedTable
     *            The class containing information about the table as introspected from the database
    ...
    /**
     * Called when the updateAllColumns method is generated. The generated method can be used with the general update
     * method to mimic the function of the old updateByExample method.
     *
     * @param method
    ...
    /**
     * This method is called when the MyBatis Dynamic SQL support class has been generated in the MyBatis Dynamic SQL
     * runtime.
     *
     * @param supportClass
     *            the generated MyBatis Dynamic SQL support class You can add additional items to the generated class if
     *            necessary.
     * @param introspectedTable
     *            The class containing information about the table as introspected from the database
     *
    ...
    /**
     * This method is called when the MyBatis Dynamic SQL support object has been generated. The format of the class is
     * an outer object with an inner class. The inner class contains the table and column definitions. The outer
     * (singleton) object contains a reference to an instance of the inner class, and shortcut properties that reference
     * the columns of that instance.
     *
     * @param kotlinFile
     *            the generated Kotlin file containing the outer object and inner class
     * @param outerSupportObject
     *            a reference to the outer object in the file
     * @param innerSupportClass
     ...
     *            The class containing information about the table as introspected from the database
     *
     * @return true if the file should be generated, false if the generated file should be ignored. In the case of
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     *
     * @deprecated this method is no longer called
     */
    ...
    /**
     * The motivation for adding this method can be found in https://github.com/mybatis/generator/issues/1116 This
     * method is called when the updateByPrimaryKey method has been generated in the dynamic SQL runtime client
     * interface.
     *
     * @param method
     ...
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    default boolean clientUpdateByPrimaryKeyMethodGenerated(Method method, Interface interfaze,
            IntrospectedTable introspectedTable) {
